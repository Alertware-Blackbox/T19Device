package com.example.librryt19.ble;
...
//        else {
    ...
    public static double extractHeartRate(
    ...
    public static short  updateHumidityValues(BluetoothGattCharacteristic characteristic) {
        return (short) (characteristic.getValue()[0] & 0xff);
    }
